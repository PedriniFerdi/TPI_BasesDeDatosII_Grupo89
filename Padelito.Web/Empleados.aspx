<%@ Page Title="Empleados" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Empleados.aspx.cs" Inherits="Padelito.Web.Empleados" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="row g-4">
        <div class="col-lg-4">
            <div class="bg-white border rounded-3 p-4">
                <h1 class="h4 mb-3">Empleado</h1>
        ...
        <div class="col-lg-8">
            <div class="bg-white border rounded-3 p-4">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h2 class="h4 mb-0">Empleados registrados</h2>
                        ...
                        <asp:TemplateField HeaderText="Acciones">
                            <ItemTemplate>
                                ...
                                <asp:LinkButton ID="btnEliminar" runat="server"
                                    ...
                                    CommandArgument='<%# Eval("IdEmpleado") %>'
                                    OnClientClick="return confirm('Desea dar de baja este empleado?');" />
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                    <EmptyDataTemplate>
                        <div class="alert alert-info mb-0">No hay empleados cargados.</div>
                    </EmptyDataTemplate>
                </asp:GridView>
            </div>
        </div>
